...
public class ServiceObjetMetier {
    ...
    public void rechercherClientParNumero(int numero) throws ServiceException {
        try {
            ...
            List<Object[]> listeClients = this.dBConnection.launchQuery("SELECT ClientID, TypeClient, Denomination, Adresse, Ville FROM CLIENT WHERE CLIENTID = "+numero+" ORDER BY ClientID");
    ...
    public void rechercherClientParDenomination(String denomination, String ville) throws ServiceException {
        try {
            ...
            List<Object[]> listeClients = this.dBConnection.launchQuery("SELECT ClientID, TypeClient, Denomination, Adresse, Ville FROM CLIENT WHERE Denomination LIKE '%"+denomination+"%' AND Ville LIKE '%"+ville+"%' ORDER BY ClientID");
    ...
    public void rechercherClientParPersonne(String idsPersonne, String ville) throws ServiceException {
        try {
            JsonArray jsonListe = new JsonArray();
            List<Object[]> listeClients = this.dBConnection.launchQuery("SELECT CLIENT.ClientID, TypeClient, Denomination, Adresse, Ville FROM CLIENT, COMPOSER WHERE CLIENT.ClientID = COMPOSER.ClientID AND PersonneId IN (" + idsPersonne + ") AND Ville LIKE '%"+ville+"%' ORDER BY ClientID");
